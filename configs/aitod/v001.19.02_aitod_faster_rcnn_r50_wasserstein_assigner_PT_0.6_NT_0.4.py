...
Average Precision  (AP) @[ IoU=0.50:0.95 | area=   all | maxDets=1500 ] = 0.134
...
+----------+-------+---------------+-------+--------------+-------+
| airplane | 0.843 | bridge        | 0.954 | storage-tank | 0.764 |
| ship     | 0.753 | swimming-pool | 0.937 | vehicle      | 0.831 |
| person   | 0.933 | wind-mill     | 0.973 | None         | None  |
+----------+-------+---------------+-------+--------------+-------+
