"""
Average Precision  (AP) @[ IoU=0.50:0.95 | area=   all | maxDets=1500 ] = 0.173
...
+----------+-------+---------------+-------+--------------+-------+
| airplane | 0.791 | bridge        | 0.903 | storage-tank | 0.730 |
| ship     | 0.733 | swimming-pool | 0.918 | vehicle      | 0.805 |
| person   | 0.926 | wind-mill     | 0.958 | None         | None  |
+----------+-------+---------------+-------+--------------+-------+
