...
Average Precision  (AP) @[ IoU=0.50:0.95 | area=   all | maxDets=1500 ] = 0.106
...
+----------+-------+---------------+-------+--------------+-------+
| airplane | 0.819 | bridge        | 0.962 | storage-tank | 0.821 |
| ship     | 0.823 | swimming-pool | 0.930 | vehicle      | 0.871 |
| person   | 0.950 | wind-mill     | 1.000 | None         | None  |
+----------+-------+---------------+-------+--------------+-------+
