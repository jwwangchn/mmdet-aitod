...
Average Precision  (AP) @[ IoU=0.50      | area=   all | maxDets=3000 ] = 0.584
Average Precision  (AP) @[ IoU=0.75      | area=   all | maxDets=3000 ] = 0.362
...
Average Precision  (AP) @[ IoU=0.50:0.95 | area= large | maxDets=3000 ] = 0.409
...
Average Recall     (AR) @[ IoU=0.50:0.95 | area= small | maxDets=3000 ] = 0.337
Average Recall     (AR) @[ IoU=0.50:0.95 | area=medium | maxDets=3000 ] = 0.477
Average Recall     (AR) @[ IoU=0.50:0.95 | area= large | maxDets=3000 ] = 0.522
