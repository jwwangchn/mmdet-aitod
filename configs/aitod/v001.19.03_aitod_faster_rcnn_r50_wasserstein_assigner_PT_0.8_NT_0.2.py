...
Average Precision  (AP) @[ IoU=0.50:0.95 | area=   all | maxDets=1500 ] = 0.095
...
+----------+-------+---------------+-------+--------------+-------+
| airplane | 0.960 | bridge        | 0.943 | storage-tank | 0.788 |
| ship     | 0.860 | swimming-pool | 0.930 | vehicle      | 0.869 |
| person   | 0.956 | wind-mill     | 0.974 | None         | None  |
+----------+-------+---------------+-------+--------------+-------+
