...
Average Precision  (AP) @[ IoU=0.50:0.95 | area=   all | maxDets=1500 ] = 0.094
...
+----------+-------+---------------+-------+--------------+-------+
| airplane | 0.822 | bridge        | 0.975 | storage-tank | 0.841 |
| ship     | 0.865 | swimming-pool | 0.921 | vehicle      | 0.899 |
