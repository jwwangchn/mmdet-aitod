...
Average Precision  (AP) @[ IoU=0.50:0.95 | area=   all | maxDets=1500 ] = 0.150
...
+----------+-------+---------------+-------+--------------+-------+
| airplane | 0.864 | bridge        | 0.893 | storage-tank | 0.782 |
| ship     | 0.689 | swimming-pool | 0.931 | vehicle      | 0.844 |
| person   | 0.937 | wind-mill     | 0.967 | None         | None  |
+----------+-------+---------------+-------+--------------+-------+
